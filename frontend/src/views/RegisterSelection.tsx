  ...
  return (
    <div className="relative flex min-h-dvh items-center justify-center overflow-hidden bg-slate-50 px-3 py-16 sm:px-4 sm:py-20 lg:py-8">
      ...
      <div className="relative z-10 w-full max-w-6xl px-1 text-center sm:px-4">
        ...
        <div className="mx-auto mt-6 flex max-w-3xl items-start gap-2.5 sm:gap-3 rounded-2xl border border-emerald-100 bg-emerald-50/70 px-4 py-3 text-left text-xs font-semibold leading-relaxed text-emerald-800">
          <ShieldCheck className="mt-0.5 h-4 w-4 shrink-0" />
          <p>herSHG registration follows the seller pathway and adds SHG-specific readiness checks such as authorization resolution, member list, SHG bank details, and registration proof. Already registered? <Link href="/login" className="underline decoration-emerald-400 underline-offset-2 font-bold">Sign in</Link>.</p>
        </div>
      </div>
    </div>
  );
