    ...
    return (
      <div className="mx-auto max-w-7xl space-y-5 animate-pulse">
        ...
        <div className="flex flex-col gap-3 border-b border-slate-200 pb-4 md:flex-row md:items-end md:justify-between">
          ...
          <div className="h-10 w-28 bg-slate-200/80 rounded-md" />
        </div>

        {/* KPI Cards Grid Skeleton */}
        <div className="grid grid-cols-2 gap-2.5 sm:gap-3 sm:grid-cols-2 lg:grid-cols-4">
          {[...Array(4)].map((_, i) => (
            <div key={i} className="h-[88px] rounded-xl border border-slate-200 bg-slate-50 p-3 shadow-sm flex flex-col justify-between">
              <div className="flex justify-between items-start">
                <div className="h-3 w-20 bg-slate-200/80 rounded" />
                <div className="h-6 w-6 rounded-md bg-slate-200/80" />
              </div>
              <div className="h-5 w-16 bg-slate-200/80 rounded mt-1.5" />
              <div className="flex items-center gap-1 mt-auto">
                <div className="h-1 w-1 rounded-full bg-slate-200/80" />
        ...
        <div className="flex flex-wrap gap-2">
          {[...Array(3)].map((_, i) => (
            <div key={i} className="h-10 w-32 rounded-md border border-slate-200 bg-slate-50" />
          ))}
        </div>
        ...
        <div className="grid gap-5 lg:grid-cols-[320px_1fr]">
          <div className="space-y-3">
            ...
            <div className="rounded-lg border border-slate-200 bg-white p-4 shadow-sm space-y-3">
              <div className="h-4 w-24 bg-slate-200/80 rounded mb-4" />
              <div className="h-10 w-full bg-slate-200/80 rounded-md" />
              <div className="h-20 w-full bg-slate-200/80 rounded-md" />
            ...
            <div className="space-y-2">
              {[...Array(3)].map((_, i) => (
                <div key={i} className="w-full rounded-lg border border-slate-200 bg-white p-3 shadow-sm space-y-2">
                  <div className="flex items-center justify-between">
                    <div className="h-4 w-32 bg-slate-200/80 rounded" />
                    <div className="h-4 w-16 bg-slate-200/80 rounded" />
                  </div>
                  <div className="h-3 w-48 bg-slate-200/80 rounded mt-2" />
          ...
          <div className="rounded-lg border border-slate-200 bg-white shadow-sm flex flex-col">
            <div className="flex flex-col gap-3 border-b border-slate-200 p-4 md:flex-row md:items-center md:justify-between">
              <div className="space-y-2">
                <div className="h-6 w-48 bg-slate-200/80 rounded" />
                <div className="h-3 w-72 bg-slate-200/80 rounded" />
              </div>
              <div className="h-10 w-32 bg-slate-200/80 rounded-md" />
            </div>
                    ...
                    {[...Array(3)].map((_, i) => (
                      <div key={i} className="flex justify-between items-center p-3">
                        <div className="space-y-2">
                          ...
                          <div className="h-3 w-56 bg-slate-200/80 rounded" />
                        </div>
                        <div className="h-6 w-11 bg-slate-200/80 rounded-full" />
                      </div>
                    ))}
                  </div>
                </div>
