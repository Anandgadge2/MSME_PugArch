  ...
  return (
    <div className="space-y-12 px-4 py-10 sm:space-y-16 sm:px-6 sm:py-16">
      ...
      <div className="mx-auto max-w-4xl space-y-6 text-center sm:space-y-8">
        <h1 className="text-3xl sm:text-5xl lg:text-7xl font-extrabold leading-[1.1] tracking-tight text-[#1d4ed8]">
          Streamline Your Procurement Onboarding with <span className="text-[#f9a825]">JsgSmile MSME</span>
        </h1>
          ...
          {!user ? (
            <>
              <Link href="/seller/register">
                <Button size="lg" className="h-14 w-full gap-2 px-6 text-base sm:h-16 sm:w-auto sm:px-8 sm:text-lg bg-gradient-to-r from-[#1d4ed8] to-[#1e3a8a] hover:from-[#1e3a8a] hover:to-[#071830] text-white font-bold shadow-[0_20px_40px_-10px_rgba(18,51,95,0.3)] border-0 transition-all hover:translate-y-[-2px] active:scale-[0.98]">
                  <Store className="h-6 w-6" />
                  <span>Join as Seller</span>
                </Button>
              </Link>
              <Link href="/buyer/register">
                <Button variant="outline" size="lg" className="h-14 w-full gap-2 border-2 border-slate-200 px-6 text-base sm:h-16 sm:w-auto sm:px-8 sm:text-lg text-[#1d4ed8] hover:bg-slate-50 hover:text-[#1d4ed8]">
            ...
            <Link href="/dashboard">
              <Button size="lg" className="h-14 w-full gap-2 px-6 text-base sm:h-16 sm:w-auto sm:px-8 sm:text-lg bg-[#1d4ed8] hover:bg-[#1e3a8a] shadow-sm">
      ...
      <div className="grid gap-6 md:grid-cols-3">
        <div className="group space-y-4 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition-all hover:shadow-md sm:p-8">
          ...
          <h3 className="text-lg font-bold text-[#1d4ed8] tracking-tight">Secure Verification</h3>
        ...
        <div className="group space-y-4 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition-all hover:shadow-md sm:p-8">
          ...
          <h3 className="text-lg font-bold text-[#1d4ed8] tracking-tight">Fast Approval</h3>
        ...
        <div className="group space-y-4 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition-all hover:shadow-md sm:p-8">
          <div className="w-14 h-14 bg-slate-100 rounded-xl flex items-center justify-center group-hover:scale-105 transition-transform">
            <ArrowRight className="h-7 w-7 text-[#1d4ed8]" />
          </div>
          <h3 className="text-lg font-bold text-[#1d4ed8] tracking-tight">Direct Integration</h3>
      ...
      <div className="flex justify-center border-t border-slate-200 pt-8 sm:pt-12">
        <Link href="/admin/register" className="text-xs font-bold text-slate-400 hover:text-[#1d4ed8] transition-colors uppercase tracking-widest">
