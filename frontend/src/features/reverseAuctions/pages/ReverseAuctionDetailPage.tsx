  ...
  if (isSeller || !user) {
    return (
      <div className="mx-auto max-w-[1600px] px-4 md:px-8 space-y-6 pb-16 pt-2">
        ...
        <AuctionClarificationPanel auctionId={id} role="seller" />
      </div>
    );
  }
    ...
    <div className="mx-auto max-w-[1600px] px-4 md:px-8 space-y-6 pb-16 pt-2">
      ...
      <div className="flex flex-col gap-4 border border-slate-200/80 bg-white p-6 sm:p-7 rounded-3xl shadow-sm md:flex-row md:items-center md:justify-between">
        <div className="space-y-1.5">
          <div className="flex flex-wrap items-center gap-2">
            ...
            <span className="text-[10px] font-black uppercase tracking-widest text-slate-400 font-mono">{auction.data.auctionCode || `RA-${id}`}</span>
          </div>
      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_380px]">
        ...
        <div className="space-y-6">
          {/* SECTION 1: Overview */}
          <Card className="border-slate-200/80 rounded-3xl shadow-sm overflow-hidden">
        ...
        {/* Right Hand: Action & Guidelines sidebar */}
        <div className="space-y-6">
          <Card className="border-slate-200/80 rounded-3xl shadow-sm overflow-hidden">
            <CardContent className="p-6 space-y-4">
              <h2 className="text-sm font-black uppercase tracking-wider text-[#0b2447] flex items-center gap-2">
                <UserPlus className="h-4 w-4 text-blue-600" /> Invite Sellers
              </h2>
              <p className="text-xs font-semibold text-slate-500">Search verified MSMEs to grant direct bidding access.</p>
              <form onSubmit={(e: FormEvent) => {
                ...
                />
                <Button disabled={invite.isPending || !selectedSeller} className="w-full rounded-xl bg-[#0b2447] hover:bg-blue-600 font-bold text-xs h-10">
          ...
          <Card className="border-slate-200/80 rounded-3xl shadow-sm overflow-hidden">
            <CardContent className="p-6 space-y-3">
              <p className="text-xs font-black uppercase tracking-widest text-[#0b2447]">Auction Guidelines</p>
