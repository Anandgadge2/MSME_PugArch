...
export function Pagination({
  ...
  return (
    <div className="flex flex-col gap-3 border-t border-slate-100 bg-white px-4 py-3 text-xs font-bold text-slate-500 sm:flex-row sm:items-center sm:justify-between">
      <div>
