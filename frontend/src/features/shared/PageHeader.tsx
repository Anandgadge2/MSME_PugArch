        ...
        <div>
            ...
            <div className="page-header">
                <div className="min-w-0">
                    {eyebrow && (
                        <p className="text-[9px] sm:text-[10px] font-black uppercase tracking-widest text-[#12335f]">{eyebrow}</p>
                    )}
                    <h1 className="text-lg sm:text-xl md:text-2xl font-black tracking-tight text-slate-950 text-wrap-anywhere">{title}</h1>
                    {description && (
                        <p className="mt-1 max-w-3xl text-[10px] sm:text-xs font-semibold text-slate-500 text-wrap-anywhere">{description}</p>
                    )}
                </div>
