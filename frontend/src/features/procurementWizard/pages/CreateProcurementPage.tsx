...
function ItemsDetailsForm({
  ...
  const serviceDetailsPanel = whatBuying === 'Service' ? (
      <div className="space-y-3 sm:space-y-4 rounded-2xl border border-blue-100 bg-blue-50/40 p-3 sm:p-4 w-full min-w-0 max-w-full">
        <h3 className="text-[11px] sm:text-xs font-bold sm:font-black text-slate-800 uppercase tracking-wide border-b border-slate-100 pb-1.5 sm:pb-2">Service Contract Parameters</h3>
