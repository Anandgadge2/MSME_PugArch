...
export default function Step3_BidBasicDetails({ data, errors, updateField }: StepComponentProps) {
  return (
    <div className="grid gap-4 md:grid-cols-2">
      ...
      <FormField label="Budget Head"><SearchableSelect value={data.budgetHead} options={BUDGET_HEADS} onChange={value => updateField('budgetHead', value)} placeholder="Select budget head..." allowOther /></FormField>
