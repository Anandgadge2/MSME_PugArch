...
const QUICK_PAGES = (role: string): Result[] => {
    const all: Array<Result & { roles?: string[] }> = [
        ...
        { id: 'p:grn', label: 'Delivery Confirmation', secondary: 'GRN', icon: ArrowRight, href: '/orders/delivery-confirmation', roles: ['buyer'] },
        ...
        { id: 'p:rfq-buyer', label: 'My Procurements', secondary: 'Procurements and supplier quotations', icon: FileText, href: '/buyer/my-procurements', roles: ['buyer'] },
        ...
        { id: 'p:invoices-buyer', label: 'Invoices', icon: ArrowRight, href: '/payments/invoices', roles: ['buyer'] },
        { id: 'p:invoices-seller', label: 'Invoices', icon: ArrowRight, href: '/payments/invoices', roles: ['seller'] },
